...
Ready to contribute? Here's how to set up `landcover_lca` for local development.

1. Download a copy of `landcover_lca` locally.
2. Install `landcover_lca` using `poetry`:
